...
// hr component
import HRPage from '../HR/Pages/HRPage/HRPage.jsx'
import Dashboard from '../HR/Components/Dashboard/Dashboard.jsx'
import List from '../HR/Components/List/List.jsx'
import Employee from '../HR/Components/Employee/Employee.jsx'
import Attendance from '../HR/Components/Attendance/Attendance.jsx'
	...
	return (
		<>
			...
			<Routes>
				...
				<Route
					path="/hr"
					element={isAuthenticated ? <HRPage /> : <Login to="/login" />}
				/>
